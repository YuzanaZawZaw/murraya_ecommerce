                ...
                <%@ taglib prefix="fmt" uri="http://java.sun.com/jsp/jstl/fmt" %>
                    ...
                    <head>
                        ...
                        <style>
                            ...
                            .checkout-btn:hover {
                                background: rgb(68, 63, 35) !important;
                    ...
                    <body>
                        ...
                        <div class="container mt-5">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 offset-md-3 mt-4 mb-4 checkout-container">
                            ...
                            document.addEventListener("DOMContentLoaded", async function () {
                                ...
                                function shoppingItemsDisplayProductDetails(product, container) {
                                    ...
                                    if (product.discountPercentage) {
                                        ...
                                        discountPercentage.innerHTML = `Discount Percentage: <span class="text-danger">` + product.discountPercentage + `% off</span>`;
                                    ...
                                    removeButton.classList.add("btn", "btn-danger", "remove-item", "mt-auto");
