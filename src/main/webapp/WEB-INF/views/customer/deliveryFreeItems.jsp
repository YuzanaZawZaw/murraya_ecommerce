            ...
            <%@ include file="/WEB-INF/views/inc/categoryDropDown.jsp" %>
                <%@ taglib prefix="fmt" uri="http://java.sun.com/jsp/jstl/fmt" %>
                    ...
                    <body>
                        ...
                        <!--Start Delivery free items Section -->
                        <div class="container mt-5">
                            <h2 class="text-center mb-4">Delivery free items</h2>
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item">Home</li>
                                    <li class="breadcrumb-item"><a href="/users/discountItems">Discount Items</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">Delivery free items</li>
                                </ol>
                            </nav>
                            <div class="row" id="deliveryfree-product-container">
                                
                            </div>
                        </div>
                        <!-- End Delivery free items Section -->
                        ...
                        <script>
                            document.addEventListener("DOMContentLoaded", async function () {
                                ...
                                const deliveryFreeProductContainer = document.querySelector(".row");
                                const productContainer = document.getElementById("deliveryfree-product-container");
                                deliveryFreeProductContainer.innerHTML = "";

                                fetch("/users/products/deliveryFreeProducts", {
                                    method: "GET",
                                    headers: {
                                    ...
                                    .catch(error => {
                                        console.error("Error fetching delivery free products :", error);
                                    });
