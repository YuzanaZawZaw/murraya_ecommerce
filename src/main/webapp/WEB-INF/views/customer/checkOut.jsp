                ...
                <%@ taglib prefix="fmt" uri="http://java.sun.com/jsp/jstl/fmt" %>
                    ...
                    <head>
                        ...
                        <style>
                            ...
                            .plcace-order-btn:hover {
                                background: rgb(68, 63, 35) !important;
                                transform: scale(1.05);
                            }

                            .plcace-order-btn:active {
                                background-color: #a2a33f;
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="card shadow-sm mb-3">
                                        <div class="card-body">
                                            ...
                                            <div class="col-md-12 offset-md-3 mt-4 mb-4 checkout-container">
                                                <button id="placeOrderButton" class="plcace-order-btn w-50">Place
                                                    Order</button>
                                            </div>
                                        </div>
                                    </div>
